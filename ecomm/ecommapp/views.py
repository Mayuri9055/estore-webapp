...
def registration(request):
    ...
    if request.method=='POST':
        ...
        if uname=="" or upass=="" or ucpass=="":
            ...
            context['errormsg']="password and conform password did not match"
            return render(request,'registration.html',context)
        else:
            try:
                ...
                context['errormsg']="user with same username alredy exist"
                return render(request,'registration.html',context)
    ...
    if request.method=='POST':
        ...
        if uname=="" or upass=="":
            ...
            if u is not None:
                ...
                context['errormsg']="invalied username and password"
                return render(request,'login.html',context)
